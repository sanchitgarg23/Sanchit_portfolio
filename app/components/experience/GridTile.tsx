...
const GridTile = (props: GridTileProps) => {
  ...
  const getGeometry = () => {
    if (!isMobile) {
      return <planeGeometry args={[2.8, 4, 1]} />
    }
    // On mobile, keep it square or proportional
    return <planeGeometry args={[3, 2, 1]} />
  };
    ...
    <mesh ref={gridRef}
      ...
      <group>
        <mesh position={[0, 0, -0.01]} ref={hoverBoxRef} scale={[0, 0, 0]}>
          <boxGeometry args={[isMobile ? 3 : 2.8, isMobile ? 2 : 4, 0.5]}/>
